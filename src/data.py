...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose([
            ...
            transforms.RandomAffine(degrees=(-15, 15), translate=(0, 0.1), scale=(1.0, 1.25),shear=(-10, 10)),
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    #rand_images = random.randint(0, len(data_loaders['train']))


    # Get class names from the train data loader
    #class_names = [classes_name.split(".")[1] for classes_name in data_loaders.classes]
    # YOUR CODE HERE
    base_path = Path(get_data_location())
    train_data = datasets.ImageFolder(
        base_path / "train",
